---
title: "ACT6100 - TP"
code permanent: "KHEA18099701 , VASB22099501 ,CHAE21119604 ,  BERK24079801 , SABR19029400"
author: "Khechman Ayman , Bogdan Vasile , Chan Edmen , Berjaoui Karim, Rami Sabeur"
date: '2020-04-26'
...
library("caret")
library("cluster")
library("fishualize") #ajouter nouvellement et retirer des packages pas nécessaires
...
data_pred %>%
  ...
  theme(
    ...
    plot.title = element_text(hjust = 0.55,size = 14 , color = "#a04000",family = "Arial Nova")
  )+
...
On remarque le *RMSE* amplifie les erreurs vu qu'il met au carré les erreurs, ce qui résulte un RMSE très élevé.
...
On essayera de vérifier ceci tout de suite , nous allons vérifier les 4 variables les plus importantes en générale.
